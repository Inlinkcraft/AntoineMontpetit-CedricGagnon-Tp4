...
public class JeuDeDes
{
	 ...
	 * une boucle qui permet de faire jouer les 3 tours ou moins, au joueur reéu
	 * en paramétre. Pour chaque tour, on affiche l'info du tour et la main du
	 * joueur. On évalue la main de dés et on affiche les points s'il y en a. On
	 * demande les numéros de dés et relancer et s'il y en a on brasse ces dés.
		...
		while (currentRoll < NBR_TOUR)
		{
			...
			if (currentRoll < NBR_TOUR - 1)
			{
				...
				String message = "Tour " + (currentRoll + 1) + "/" + NBR_TOUR
						...
						+ "\n\nChoisir le numéro des dés que vous voulez relancer (\"Annuler\" pour arréter la saisie)!";
	 ...
	 * arréte son évaluation lorsqu'elle trouve une séquence valide (présente
	 * dans la main).
	 * 
