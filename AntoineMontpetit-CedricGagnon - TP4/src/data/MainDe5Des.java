...
public class MainDe5Des
{
	...
	/**
	 * Brasse chaque dé indiqué par son numéro dans la chaéne de caractéres
	 * reçue. Exemple si on reçoit la chaine "235" on doit brasser les dés
	 * numéro 2, 3 et 5. Vous trouverez dans la classe Character une méthode qui
	 * retourne la valeur numérique d'un caractére
	 * 
	 ...
	 * [1] [2] [1] [0] La main posséde donc un 1, zéro 2, un 3, deux 4, un 5 et
	 * zéro 6
	 * 
